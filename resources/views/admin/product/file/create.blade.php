        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">File Writer</div>
                            <hr />
                            <form method="POST" class="insert_form" action="{{ route('file_resource.store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <label for="input-21" class="col-sm-2 col-form-label">Upload file</label>
                                    <div class="col-sm-10">
                                        <input type="file" name="pathfile" class="form-control" id="input-21"/>
