        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">Edit Category Course</div>
                            <hr />
                            <form method="POST" class="update_form" action="{{ route('categoryCourse.update',$category->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <input  name="id" value="{{ $category->id }}" type="hidden" class="form-control" id="input-21" placeholder="Name" />
